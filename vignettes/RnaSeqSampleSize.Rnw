...
<<distributionPower2,echo=TRUE,tidy=TRUE,cache=TRUE>>=
...
powerDistribution<-est_power_distribtuion(n=65,f=0.01,rho=2,distributionObject="TCGA_READ",selectedGenes=selectedGenes,storeProcess=TRUE)
